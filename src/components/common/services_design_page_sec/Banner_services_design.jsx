...
import './Banner_services_design.css'
import arrowServices from './images/arrowServices.png';
function Banner_services_design(){
    return(
        <section className='banner-services'> 
            <div className='banner-services-main-title'>we&nbsp;create</div>
            <div className='banner-services-title'>unique design</div>
...
export default Banner_services_design;