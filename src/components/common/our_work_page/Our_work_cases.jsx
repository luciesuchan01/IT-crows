          ...
          <div class="grid-container-our-work">
                ...
                <div class="grid-item-our-work">
                    <div className='grid-item-left-our-work'>
                        <img src={todolist} alt="todo list image" width="100%" height="90%"/>
                ...
                <div class="grid-item-our-work">
                    <div class="grid-item-right-our-work">
                        <img src={lorem} alt="loading page image" width="100%" height="85%"/>
            ...
            <div className='grid-container-second-our-work'>
                <div className='grid-item-second-our-work'>
                    <div class="grid-item-left-our-work">
                        <img src={lorem2} alt="e-commerce image" width="100%" height="100%"/>
            ...
            <div class="grid-container-our-work">
                <div class="grid-item-our-work">
                    <div class="grid-item-left-our-work">
                        ...
                        <img src={graciano} alt="graciano image" width="100%" height="100%"/>
                        <h1>graciano
                        <h2>
                            <div className='first-pic'>UI/UIX, develop, e-commerce</div>
                        </h2>
                ...
                <div class="grid-item-our-work">
                    <div class="grid-item-right-our-work">
                    <img src={ pujc } alt="lending cars page image" width="95%" height="93%"/>
                ...
                <div class="grid-item-our-work">
                    <div class="grid-item-right-our-work">
                    <img src={lorem} alt="e-commerce image" width="100%" height="85%"/>
